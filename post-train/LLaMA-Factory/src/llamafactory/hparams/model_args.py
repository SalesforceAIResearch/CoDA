...
class ModelArguments:
    ...
    torchprime_config: Optional[str] = field(
        default=None,
        metadata={"help": "Path to the torchprime model configuration YAML file."},
    )
    update_tokenizer: bool = field(
        default=False,
        metadata={"help": "Whether to update the tokenizer when loading torchprime models."},
    )
