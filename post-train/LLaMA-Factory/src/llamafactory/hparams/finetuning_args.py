...
class DiffusionArguments:
    ...
    """
    progress_src_mask: bool = field(
        default=False,
        metadata={"help": "Whether to progressively relax src_mask based on training progress."}
    )
    progress_src_mask_ratio: float = field(
        default=0.1,
        metadata={"help": "The ratio of the src_mask to be relaxed."}
    )
